...
Read your Obsidian notes aloud using Google's Gemini 2.5 API with text-to-speech capabilities.
...
### Model Name
The Gemini model to use for TTS (default: `gemini-2.5-flash-tts`).
